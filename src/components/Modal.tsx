...
export default function Modal({ title, onClose, children }: { title: string; onClose: () => void; children: ReactNode }) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" style={{ background: "rgba(13,27,62,.45)" }}>
      <div className="w-full max-w-md bg-surface rounded-2xl p-5" style={{ boxShadow: "0 20px 60px rgba(13,27,62,.25)" }}>
